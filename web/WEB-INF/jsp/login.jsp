...
<div class="headerAd">
	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span12">
<div class="ad">
					<img src="${pageContext.request.contextPath}/resource/img/login.jpg" width="500" height="330" alt="会员登录" title="会员登录">
</div>		</div>
							...
							<tr class="register">
								...
								<td>
									<dl>
										...
										<dd>
											立即注册即可体验在线购物！
											<a href="${ pageContext.request.contextPath }/userRegist.action">立即注册</a>
										</dd>
									</dl>
								</td>
							</tr>
...
<div class="container footer">
	<div class="span24">
	  <div class="footerAd"><img src="${pageContext.request.contextPath}/resource/img/footer.jpg" width="950" height="52" alt="我们的优势" title="我们的优势" /></div>
	</div>
	<div class="span24">
		<ul class="bottomNav">
					<li>
